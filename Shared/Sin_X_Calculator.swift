...
class Sin_X_Calculator: ObservableObject {
    ...
    func calculate_sin_xMinus1(x: Double) -> Double{
        ...
        sinXminusOne = calculate1DInfiniteSum(function: sinnthTermMultiplier, x: x, minimum: 1, maximum: 100, firstTerm: firstTerm, isPlotError: plotError, errorType: sinErrorCalculator  )
